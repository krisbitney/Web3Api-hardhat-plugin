...
export function serializesendTransactionArgs(
...
export function writesendTransactionArgs(
  ...
  if (input.connection) {
    Types.Ethereum_Connection.write(
      writer,
      input.connection as Types.Ethereum_Connection
    );
  } else {
    writer.writeNil();
  }
...
export function serializedeployContractArgs(
